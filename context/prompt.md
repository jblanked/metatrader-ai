...
- Scheduling supports one-time, daily, weekdays, and weekly tasks. Scheduled tool calls run without an additional confirmation. A missed one-time task expires; a missed recurring occurrence is skipped and the next occurrence remains scheduled.
